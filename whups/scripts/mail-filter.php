 ...
 *
 * $Horde: whups/scripts/mail-filter.php,v 1.36 2008/06/24 22:26:06 jan Exp $
 */
...
@define('WHUPS_BASE', HORDE_BASE . '/whups');
require_once WHUPS_BASE . '/lib/base.php';
require_once WHUPS_BASE . '/lib/Mail.php';
...
if (isset($opts_hash['--default-auth'])) {
    ...
    $auth->setAuth($info['default_auth'], array());
}
