 ...
 * Whups RSS feed.
 *
 * $Horde: whups/queue/rss.php,v 1.17.2.1 2009/01/06 15:28:33 jan Exp $
 *
...
if ($state_category) {
    ...
    $state_display = String::ucFirst($state_category);
...
$template->set('url',
               Util::addParameter(Horde::applicationUrl('queue/', true, -1),
                                  'id', $id));
$template->set('rss_url',
               Util::addParameter(Horde::applicationUrl('rss.php', true, -1),
                                  'id',  $id));
if (isset($queue['name'])) {
