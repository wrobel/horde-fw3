 ...
 *
 * $Horde: whups/lib/Forms/Admin/Reply.php,v 1.1.2.1 2009/01/06 15:28:21 jan Exp $
 *
    ...
    function EditReplyStep2Form(&$vars)
    {
        ...
        if (Auth::isAdmin('whups:admin', PERMS_EDIT)) {
            $permslink = array(
                ...
                'url' => Util::addParameter(Util::addParameter(Horde::url($GLOBALS['registry']->get('webroot', 'horde') . '/admin/perms/edit.php'), 'category', "whups:replies:$reply"), 'autocreate', '1'));
