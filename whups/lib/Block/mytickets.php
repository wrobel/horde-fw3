 ...
 *
 * $Horde: whups/lib/Block/mytickets.php,v 1.9.2.1 2008/11/06 01:50:19 chuck Exp $
 *
 * @package Horde_Block
 */
class Horde_Block_Whups_mytickets extends Horde_Block {
    ...
    function _content()
    {
        ...
        $queue_ids = array_keys(Whups::permissionsFilter($whups_driver->getQueues(), 'queue', PERMS_READ));
        $info = array('owner' => Whups::getOwnerCriteria(Auth::getAuth()),
                      'nores' => true,
                      'queue' => $queue_ids);
