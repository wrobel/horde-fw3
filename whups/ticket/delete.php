 ...
 *
 * $Horde: whups/ticket/delete.php,v 1.23.2.1 2009/01/06 15:28:39 jan Exp $
 *
...
class DeleteTicketForm extends Horde_Form {
    ...
    {
        if (!Whups::hasPermission($this->_queue, 'queue', PERMS_DELETE)) {
...
if (!Whups::hasPermission($details['queue'], 'queue', PERMS_DELETE)) {
