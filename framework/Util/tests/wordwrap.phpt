...
echo String::wordwrap($string, 75, "\n", false, 'utf-8') . "\n\n";
echo String::wordwrap($string, 30, "\n  ", false, 'utf-8') . "\n\n";
...
echo String::wordwrap($string, 15, "\n", false, 'utf-8') . "\n\n";
$string = "Löremipsümdölörsitämet, cönsectetüerädipiscingelit.";
echo String::wordwrap($string, 15, "\n", true, 'utf-8') . "\n\n";

// Test whitespace at wrap width.
$string = "Lörem ipsüm dölör sit ämet, cönsectetüer ädipiscing";
echo String::wordwrap($string, 27, "\n", false, 'utf-8') . "\n\n";
echo String::wordwrap($string, 28, "\n", false, 'utf-8') . "\n\n";

// Test line folding.
$string = "Löremipsümdölörsitämet, cönsectetüerädipiscingelit.";
echo String::wordwrap($string, 15, "\n", true, 'utf-8', true) . "\n\n";
$string = "Lörem ipsüm dölör sit ämet,  cönsectetüer ädipiscing elit.  Aliqüäm söllicitüdin fäücibüs mäüris ämet.";
echo String::wordwrap($string, 31, "\n", false, 'utf-8', true) . "\n\n";
$string = "Lörem ipsüm dölör sit; ämet:  cönsectetüer ädipiscing elit.  Aliqüäm söllicitüdin fäücibüs mäüris ämet.";
echo String::wordwrap($string, 31, "\n", false, 'utf-8', true) . "\n\n";
$string = "Lörem ipsüm dölör sit; ämet:cönsectetüer ädipiscing elit.  Aliqüäm söllicitüdin fäücibüs mäüris ämet.";
echo String::wordwrap($string, 31, "\n", false, 'utf-8', true) . "\n\n";
