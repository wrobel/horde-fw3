...
<ol class="star-rating" for="' . htmlspecialchars($edit) . '">
 ...
 <li><a href="' . Util::addParameter($edit, 'r', 1) . '" title="' . _("1 star out of 5") . '" rating="1" class="one-star">1</a></li>
 <li><a href="' . Util::addParameter($edit, 'r', 2) . '" title="' . sprintf(_("%d stars out of 5"), 2) . '" rating="2" class="two-stars">2</a></li>
 <li><a href="' . Util::addParameter($edit, 'r', 3) . '" title="' . sprintf(_("%d stars out of 5"), 3) . '" rating="3" class="three-stars">3</a></li>
 <li><a href="' . Util::addParameter($edit, 'r', 4) . '" title="' . sprintf(_("%d stars out of 5"), 4) . '" rating="4" class="four-stars">4</a></li>
 <li><a href="' . Util::addParameter($edit, 'r', 5) . '" title="' . sprintf(_("%d stars out of 5"), 5) . '" rating="5" class="five-stars">5</a></li>
</ol>';
}
