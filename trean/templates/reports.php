...
<div class="reportheader"><?php echo Horde::img('http/1xx.png') . ' ' . Horde::link(Util::addParameter(Horde::selfUrl(true), 'drilldown', '1xx')) . sprintf(_("1xx Response Codes (%s)"), $counts['1xx']) ?></a></div>
...
<div class="reportheader"><?php echo Horde::img('http/2xx.png') . ' ' . Horde::link(Util::addParameter(Horde::selfUrl(true), 'drilldown', '2xx')) . sprintf(_("2xx Response Codes (%s)"), $counts['2xx']) ?></a></div>
...
<div class="reportheader"><?php echo Horde::img('http/3xx.png') . ' ' . Horde::link(Util::addParameter(Horde::selfUrl(true), 'drilldown', '3xx')) . sprintf(_("3xx Response Codes (%s)"), $counts['3xx']) ?></a></div>
...
<div class="reportheader"><?php echo Horde::img('http/4xx.png') . ' ' . Horde::link(Util::addParameter(Horde::selfUrl(true), 'drilldown', '4xx')) . sprintf(_("4xx Response Codes (%s)"), $counts['4xx']) ?></a></div>
...
<div class="reportheader"><?php echo Horde::img('http/5xx.png') . ' ' . Horde::link(Util::addParameter(Horde::selfUrl(true), 'drilldown', '5xx')) . sprintf(_("5xx Response Codes (%s)"), $counts['5xx']) ?></a></div>
...
<div class="reportheader"><?php echo Horde::img('http/error.png') . ' ' . Horde::link(Util::addParameter(Horde::selfUrl(true), 'drilldown', 'error')) . sprintf(_("DNS Failure or Other Error (%s)"), $counts['error']) ?></a></div>
<?php endif; ?>
