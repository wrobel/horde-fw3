 ...
 * stories.
 *
 * $Horde: jonah/lib/Forms/Story.php,v 1.10 2008/01/02 11:13:18 jan Exp $
 *
...
class StoryForm extends Horde_Form
{
    ...
    function StoryForm(&$vars)
    {
        ...
        $t = &$this->addVariable('', 'publish_time', 'hourminutesecond', false, false, _("Note: this story won't be delivered to distribution lists automatically if this time is in the future."));
        ...
        $this->addVariable(_("Tags"), 'story_tags', 'text', false, false, null);
