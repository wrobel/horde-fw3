 ...
 *
 * $Horde: agora/lib/Template.php,v 1.5.2.2 2009/01/06 15:22:13 jan Exp $
 *
...
define('AGORA_TEMPLATE_STRING', '**string');

class Agora_Template {
     ...
     */
    function Agora_Template($basepath = null)
    {
        if (!is_null($basepath)) {
    ...
    function setTemplate($template)
    {
        ...
        $this->_parse();
        $this->_templateFile = AGORA_TEMPLATE_STRING;
    }
    ...
    function fetch($filename = null)
    {
        ...
        if (!$force && is_null($this->_template) && isset($this->_cache)) {
            $cacheid = 'agora_template|' . filemtime($file) . '|' . $file;
