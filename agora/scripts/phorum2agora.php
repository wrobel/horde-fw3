 ...
 *
 * $Horde: agora/scripts/phorum2agora.php,v 1.6 2006/12/16 15:26:11 duck Exp $
 *
 */
...
foreach ($messages as $message) {
    ...
    $params[] = String::convertCharset($message['subject'], $conf['sql']['charset']);
    $params[] = String::convertCharset($message['body'], $conf['sql']['charset']);
