 ...
 *
 * $Horde: nag/scripts/upgrades/convert_datatree_shares_to_sql.php,v 1.1.2.5 2008/10/23 15:50:34 jan Exp $
 */
...
while ($row = $shares_result->fetchRow(MDB2_FETCHMODE_ASSOC)) {
    ...
    $data = array('share_id' => $db->nextId('nag_shares'),
